...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "ChatStreamEndEventY8Gq2XFinishReason": ".types",
    ...
    "TextAssistantMessageContentOneItem": ".types",
    ...
    "Thinking": ".types",
    "ThinkingAssistantMessageContentOneItem": ".types",
    ...
    "V2PromptRequestDocumentsItem": ".v2",
    "V2PromptRequestSafetyMode": ".v2",
    "V2PromptRequestToolChoice": ".v2",
    "V2RerankResponse": ".v2",
